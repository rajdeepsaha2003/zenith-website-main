    ...
    <div className="everything-img-wrap">
        ...
        <div className="time-cart">
            ...
            <div className="time-cart-btn-wrap">
             <Link href="/"legacyBehavior><a className="time-cart-btn time-cart-btn-1">Schedule Post</a></Link>
             <Link href="/"legacyBehavior><a className="time-cart-btn time-cart-btn-2">See Insight</a></Link>
            </div>
        </div>
    </div>
</div>
