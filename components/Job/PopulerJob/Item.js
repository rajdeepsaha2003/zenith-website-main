...
<div className="single-popular-job-item">
    ...
    <div className="popular-job-content">
        <h3><Link href="/"legacyBehavior><a>Associate Product Marketing Consumer Marketing</a></Link></h3>
        <ul>
    ...
    <div className="popular-job-apply">
            <ul>
                ...
                <li> <Link href="/"legacyBehavior><a>Apply Now <i className="bi bi-arrow-right-short"></i> </a></Link></li>
            </ul>
    </div>
</div>
</>
